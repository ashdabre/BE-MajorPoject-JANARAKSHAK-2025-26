...
import { Chrome as Home, FileText, Users, ChartBar as BarChart3, Bell, Settings, Crown, Target, Calendar, Shield } from 'lucide-react-native';
  ...
  return (
    <View style={styles.iconWrapper}>
      ...
      <Animated.View style={[animatedStyle]}>
        <Icon size={22} color={focused ? '#7C3AED' : '#94A3B8'} strokeWidth={focused ? 2.5 : 2} />
      </Animated.View>
    </View>
  );
}
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Assign',
          tabBarIcon: ({ focused, color }) => (
            <TabBarIcon focused={focused} icon={Target} color={color} />
          ),
        }}
      />
      <Tabs.Screen
